...
-- String or list of strings specifying extensions for which the relevant highlighting autocmds regarding marker-highlighting, textcell-highlighting, etc. will be created. For example, `vim.g.jukit_hl_extensions=['py', 'R']` will enable the defined highlighting options for `.py` and `.R` files. Use `vim.g.jukit_hl_extensions='*'` to enable them for all files and `vim.g.jukit_hl_extensions=''` to disable them completely
