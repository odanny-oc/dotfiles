...
s("prenotes", fmt(
	...
	{{colback=LimeGreen!50colframe=OliveGreen!80!blackfonttitle=\bfseries}}{{def}}
	...
	\title{{%
	\normalfont \normalsize
	\textsc{{Junior Sophister Notes}} \\ [25pt] % Your university school and/or department name(s)
